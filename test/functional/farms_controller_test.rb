...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { bushes: @farm.bushes, latitude: @farm.latitude, longitude: @farm.longitude, name: @farm.name, notes: @farm.notes, workers: @farm.workers }
    end
  ...
  test "should update farm" do
    put :update, id: @farm, farm: { bushes: @farm.bushes, latitude: @farm.latitude, longitude: @farm.longitude, name: @farm.name, notes: @farm.notes, workers: @farm.workers }
    assert_redirected_to farm_path(assigns(:farm))
  end
